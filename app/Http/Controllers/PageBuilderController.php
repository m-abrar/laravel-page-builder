...
class PageBuilderController extends Controller
{
    ...
    public function save(Request $request, $id)
    {
        ...
        // Retrieve the updated page instance
        $page = Page::find($id);
        if (!$page) {
        ...
        $html = $this->processImages($page, $request->html);
        $page->update(['html' => $html, 'css' => $request->css]);
     ...
     */
    private function processImages(Page $page, $html)
    {
